...
public class Fachada {
	...
	private void instanciarRepositorios() {
	    ...
	    iRepositorioEndereco = new RepositorioEndereco();
	    controladorEndereco = new ControladorEndereco(iRepositorioEndereco);
	}
	...
	public Map<String, String> consultaMaps(String origem, String destino){
		return controladorTaxi.consultaMaps(origem, destino);
	}
	
	//TODO ENDERECO
	
	public List<Endereco> listaEndereco(){
		return controladorEndereco.lista();
	}
